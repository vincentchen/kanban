...
(
   ...
   files_id             INT(22) NOT NULL COMMENT '文件ID',
   PRIMARY KEY(request_id, files_id)
)
TYPE = InnoDB;
...
(
   ...
   versions              INT(5) NOT NULL DEFAULT 0 COMMENT '版本',
...
(
   ...
   files_id             INT(22) NOT NULL COMMENT '文件ID',
   PRIMARY KEY(target_id, files_id)
)
TYPE = InnoDB;
