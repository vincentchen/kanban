...
<body style="width:100%;overflow-y:hidden">
		...
		<div class="boxradius" style="margin:0 auto;width:90%;">
			<table class="gTab">
				<tr>
					...
					<td>
						<input type="text" id="title" value="<s:property value="#request.Info.title" />" style="width:95%;">
					</td>
				</tr>
				<tr>
					<td colspan="2">
	...
	function Submit(){
		$.ajax({
			type:"POST",
			url:"<%=basePath%>admin/AdminIdeaSaveSearch",
			data:{
			...
			success:function SubmitOK(data){
				...
				if (json_data[0].error != "") {
					...
					window.parent.window.location.href = "<%=basePath%>admin/AdminIdeaList?search=1";
				}
			}
		});
	}
