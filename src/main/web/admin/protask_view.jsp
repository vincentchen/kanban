		...
		<div style="width:100%;height:100%;">
			<table class="gTab" style="height:100%;">
				<tr style="border-bottom:1px solid #E5E5E5;height:50px;">
					...
					<td>
						<s:text name="create.user" />:<s:property value="#request.ProTask.create_user_name" />
					</td>
					<td>
					...
					<td style="width:350px;">
						<table style="width:100%;">
							<tr>
								...
								<td><s:if test="#request.ProPri.WRITE>0 && #request.ProTask.status_value != 200 && #request.ProTask.status_value != 300"><a href="javascript:void(0);" onclick="OpenDescription();"><img src="<%=basePath%>image/clipboard.png" /><s:text name="edit" /></s:if></a>
								</td>
