...
<body style="width:100%;height:98%;">
	...
	<div style="margin:5px auto;width:98%;height:90%;overflow: hidden;">
		<ul id="selectTab" style="width:200%;height:98%;list-style-type:none;">
	...
	function SelectTab(tabName) {
		...
		if (tabName == 'gantt') {
			$("#selectBG").animate({
				...
				width:$("#ganttli").width()+6+"px",
				height:$("#ganttli").height()+6+"px"
			}, 300);
			$("#selectTab").animate({
				marginLeft : "-100%"
			}, 300);
			...
			$("#selectBG").animate({
				marginLeft : $("#" + tabName + "li").css("margin-left"),
				width:$("#burndownli").width()+6+"px",
				height:$("#burndownli").height()+6+"px"
			}, 300);
			$("#selectTab").animate({
				marginLeft : "0"
			}, 300);
	...
	var ganttValues = [<s:property escape="false" value="#request.Graph[5]" />];
	function GanttDraw(){
