...
<body style="width:100%;height:98%;">
	...
	<input id="Help" type="hidden" value="<s:property value="#Global.RegisterID('Help',#request.RequestId)" />">
	<div style="margin:3px auto;height:35px;">
		<ul style="width:180px;margin:3px auto;height:31px;list-style-type:none;background-color:#fff">
			...
			<s:if test="#request.Help.seek_help_user_id == #session.user_id">
							...
							<div class="ListDiv">
								<table class="gTab">
									<tr>
										...
										<td rowspan="2" style="width:35px;height:33px;"><img alt="" src="<%=basePath%>image/download.png">
										</td>
									</tr>
									<tr>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#uploadify').uploadify({
				...
				'uploader' : 'SystemFilesUpload',
				'width' : 70,
				'height' : 37,
				'formData' : {'tblName':'Help','tblId':$("#Help").val()},
