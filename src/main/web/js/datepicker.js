...
!function( $ ) {
	...
	Datepicker.prototype = {
		...
		place: function(){
			...
			var date_div_top = offset.top + this.height;
			var date_div_left = offset.left;
			var date_div_width = this.picker.width();
			var date_div_height = this.picker.height();
			
			if((offset.left+date_div_width)>client_width){
				date_div_left = offset.left - date_div_width;
			}
			if((offset.top + this.height+date_div_height)>client_height){
				date_div_top = offset.top-date_div_height-this.height/2;
			}
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr>'+
								'<th class="prev"><i class="icon-arrow icon-arrow-left"/></th>'+
								'<th colspan="5" class="switch"></th>'+
								'<th class="next"><i class="icon-arrow icon-arrow-right"/></th>'+
							'</tr>'+
						'</thead>',
		contTemplate: '<tbody><tr><td colspan="7"></td></tr></tbody>'
	};
	DPGlobal.template = '<div class="datepicker dropdown-menu">'+
							'<div class="datepicker-before"></div><div class="datepicker-after"></div>'+
