				...
				if (desc)
				{
					...
					bar
					  .mouseover(function(e){
					  	...
					  	$("body").append(hint);
						if(e.pageX>client_width/2){
							toolLeft = e.pageX-($('.fn-gantt-hint').width())-15;
						}else{
							toolLeft = e.pageX+15;
						}
						if(e.pageY>client_height/2){
							toolTop = e.pageY-15;
						}else{
							toolTop = e.pageY+15;
						}
						$('.fn-gantt-hint').css('left', toolLeft);
						$('.fn-gantt-hint').css('top', toolTop);
						$('.fn-gantt-hint').show();
					  })
					  .mouseout(function(){
